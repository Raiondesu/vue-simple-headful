  ...
  <div class="chrome-tabs">
    <div class="chrome-tabs-content">
      <div class="chrome-tab chrome-tab-current">
        ...
        <div class="chrome-tab-favicon" style="background-image: url('https://avatars3.githubusercontent.com/u/2767948?s=400&v=4')"></div>
      ...
      <div class="chrome-tab" v-if="showGithub">
        ...
        <div class="chrome-tab-title">troxler/vue-headful: Set document title and meta tags with Vue.js</div>
...
export default {
  headful: {
    ...
    html: {
      '#favicon': { href: 'https://avatars3.githubusercontent.com/u/2767948?s=400&v=4' },
